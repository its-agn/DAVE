  ...
  return (
    <main className="min-h-screen bg-linear-to-br from-fuchsia-950 via-purple-950 to-slate-900 px-4 py-8 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 lg:flex-row">
        {/* Left column: swing replay */}
        <div className="flex flex-col rounded-3xl border border-white/10 bg-slate-900/80 p-4 shadow-2xl shadow-black/30 backdrop-blur lg:w-[380px] lg:shrink-0">
          <SwingReplay frames={frames} />
        </div>
